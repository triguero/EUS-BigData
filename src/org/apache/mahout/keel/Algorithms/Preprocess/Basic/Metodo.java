 ...
 * 
 */
package org.apache.mahout.keel.Algorithms.Preprocess.Basic;
...
public class Metodo {
	  ...
	  // data para estratificacion.
	  
	  protected double estratos_datosTrain[][][];
	  protected int estratos_clasesTrain[][];
	  protected boolean estratos_nulosTrain[][][];
	  protected int estratos_nominalTrain[][][];
	  protected double estratos_realTrain[][][];
	...
	/**
	 * Método para crear los estratos del conjunto de training.
	 * 
	 * @param ficheroScript
	 * @param train
	...
	public Metodo (String ficheroScript, InstanceSet train, int strata) {
        ...
        try{
        	normalizar_estratificar(strata);
        }catch (Exception e) {
		  System.err.println(e);
		  System.exit(1);
		}
	...
	/*
	  ...
	  public void computeStrata(){
			...
			valid=true;
			asign = new int [training.getNumInstances()];
	 ...
	 */	
	protected void normalizar_estratificar (int strata) throws CheckException {
		...
		estratos_datosTrain = new double[strata][training.getNumInstances()][Attributes.getInputNumAttributes()];
		estratos_clasesTrain = new int[strata][training.getNumInstances()];
		caja = new double[1];
